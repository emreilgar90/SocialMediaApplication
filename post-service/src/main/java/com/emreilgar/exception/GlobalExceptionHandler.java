...
import static com.emreilgar.exception.ErrorType.BAD_REQUEST;
import static com.emreilgar.exception.ErrorType.INTERNAL_ERROR;
...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> handlerAuthMicroserviceException(PostManagerException exception){
