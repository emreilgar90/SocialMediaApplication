...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ResponseEntity<ErrorMessage> handlerAuthMicroserviceException(AuthManagerException exception){
    ...
    @ExceptionHandler(DataIntegrityViolationException.class) //@Column(unique = true) anatasyonundan kaynaklı hataları yakalaması için
    @ResponseBody
    public final ResponseEntity<ErrorMessage> handlePSQLException(
            DataIntegrityViolationException exception) {
        ErrorType errorType = USERNAME_DUPLICATE;
        return new ResponseEntity<>(createErrorMessage(exception,errorType), errorType.getHttpStatus());
    }
